    ...
    <div>
      <div className="slidesection">
        <div className="slideimagelist">
          <div> <Button className={`${min === 0 ? "chevron_btn disabled" : "chevron_btn"} chevron_prevbtn`} disabled={min === 0 ? true : false} onClick={() => decrementMinMax()} ><img src={chevron_up} /></Button> </div>
          ...
          <div> <Button className={`${max === sliderImages.length ? "chevron_btn disabled" : "chevron_btn"} chevron_nextbtn`} disabled={max === sliderImages.length ? true : false} onClick={() => incrementMinMax()} ><img src={chevron_down} /></Button> </div>
        </div>
      </div>
    </div>
  );
