    ...
    <div className="AccordionSection">
      ...
      >
        <AccordionSummary
          ...
          expandIcon={
            expanded === "panel1" ? (
              <img src={description_on} className="descpicon"/>
            ) : (
              <img src={description_off} className="descpicon"/>
            )
          }
        >
      ...
      >
        ...
        <AccordionDetails>
          ...
          <div className="Offerslist">
            <span><img src={discount_icon} className="discount_icon"/></span>
            <span>
              10% off on SBI Credit Card, up to ₹1,750, on orders of ₹5000 and
              above <a href="#" className="TClink">T&C</a>
            </span>
          </div>
          <div className="Offerslist">
          <span><img src={discount_icon} className="discount_icon"/></span>
            <span>
              ...
              orders of ₹5000 and above <a href="#" className="TClink">T&C</a>
            </span>
          </div>
          <div className="Offerslist">
          <span><img src={discount_icon} className="discount_icon"/></span>
            <span>
              ...
              cart value of INR 29,999 and above <a href="#" className="TClink">T&C</a>
            </span>
          </div>
          <div className="Offerslist">
          <span><img src={discount_icon} className="discount_icon"/></span>
            <span>
              No cost EMI ₹8,815/month. Standard EMI also available <a href="#" className="TClink">View plans</a>
            </span>
          </div>
          </div>
        </AccordionDetails>
